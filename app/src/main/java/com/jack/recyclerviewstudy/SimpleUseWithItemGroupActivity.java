 ...
 */
public class SimpleUseWithItemGroupActivity extends BaseActivity implements ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uiBinding.simpleUseRv.addItemDecoration(new SectionDecoration(this, new SectionDecoration.DecorationCallback() {
            @Override
